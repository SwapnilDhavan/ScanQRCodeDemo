...
//Custom alert Dialog
extension UIViewController {
    func AlertDialog(msg: String, isBtnNo: Bool, status: Bool, completion: @escaping (Bool) -> Void) -> Void{
...
struct AppFontName {
    static let regular = "AvantGarde Normal"
    static let bold = "AvantGarde Normal"
    static let italic = "AvantGarde Normal"
}
